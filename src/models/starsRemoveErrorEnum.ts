...
/**
 * Enum for StarsRemoveErrorEnum
 */
export enum StarsRemoveErrorEnum {
...
/**
 * Schema for StarsRemoveErrorEnum
 */
export const starsRemoveErrorEnumSchema: Schema<StarsRemoveErrorEnum> = stringEnum(
