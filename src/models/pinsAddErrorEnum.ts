...
/**
 * Enum for PinsAddErrorEnum
 */
export enum PinsAddErrorEnum {
...
/**
 * Schema for PinsAddErrorEnum
 */
export const pinsAddErrorEnumSchema: Schema<PinsAddErrorEnum> = stringEnum(
  PinsAddErrorEnum
);
