...
/**
 * Enum for StarsAddErrorEnum
 */
export enum StarsAddErrorEnum {
...
/**
 * Schema for StarsAddErrorEnum
 */
export const starsAddErrorEnumSchema: Schema<StarsAddErrorEnum> = stringEnum(
  StarsAddErrorEnum
);
