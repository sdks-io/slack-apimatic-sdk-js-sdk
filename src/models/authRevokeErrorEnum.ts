...
/**
 * Enum for AuthRevokeErrorEnum
 */
export enum AuthRevokeErrorEnum {
...
/**
 * Schema for AuthRevokeErrorEnum
 */
export const authRevokeErrorEnumSchema: Schema<AuthRevokeErrorEnum> = stringEnum(
  AuthRevokeErrorEnum
);
