...
/**
 * Enum for FilesDeleteErrorEnum
 */
export enum FilesDeleteErrorEnum {
...
/**
 * Schema for FilesDeleteErrorEnum
 */
export const filesDeleteErrorEnumSchema: Schema<FilesDeleteErrorEnum> = stringEnum(
