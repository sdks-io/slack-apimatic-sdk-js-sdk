...
/**
 * Enum for DialogOpenErrorEnum
 */
export enum DialogOpenErrorEnum {
...
/**
 * Schema for DialogOpenErrorEnum
 */
export const dialogOpenErrorEnumSchema: Schema<DialogOpenErrorEnum> = stringEnum(
  DialogOpenErrorEnum
);
