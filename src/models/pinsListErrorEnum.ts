...
/**
 * Enum for PinsListErrorEnum
 */
export enum PinsListErrorEnum {
...
/**
 * Schema for PinsListErrorEnum
 */
export const pinsListErrorEnumSchema: Schema<PinsListErrorEnum> = stringEnum(
  PinsListErrorEnum
);
