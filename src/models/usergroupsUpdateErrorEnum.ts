...
/**
 * Enum for UsergroupsUpdateErrorEnum
 */
export enum UsergroupsUpdateErrorEnum {
...
/**
 * Schema for UsergroupsUpdateErrorEnum
 */
export const usergroupsUpdateErrorEnumSchema: Schema<UsergroupsUpdateErrorEnum> = stringEnum(
