...
/**
 * Enum for ReactionsListErrorEnum
 */
export enum ReactionsListErrorEnum {
...
/**
 * Schema for ReactionsListErrorEnum
 */
export const reactionsListErrorEnumSchema: Schema<ReactionsListErrorEnum> = stringEnum(
