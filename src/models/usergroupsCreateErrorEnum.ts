...
/**
 * Enum for UsergroupsCreateErrorEnum
 */
export enum UsergroupsCreateErrorEnum {
...
/**
 * Schema for UsergroupsCreateErrorEnum
 */
export const usergroupsCreateErrorEnumSchema: Schema<UsergroupsCreateErrorEnum> = stringEnum(
