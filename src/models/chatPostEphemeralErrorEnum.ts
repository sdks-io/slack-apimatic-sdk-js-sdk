...
/**
 * Enum for ChatPostEphemeralErrorEnum
 */
export enum ChatPostEphemeralErrorEnum {
  ...
  UserNotInChannel = 'user_not_in_channel',
...
/**
 * Schema for ChatPostEphemeralErrorEnum
 */
export const chatPostEphemeralErrorEnumSchema: Schema<ChatPostEphemeralErrorEnum> = stringEnum(
