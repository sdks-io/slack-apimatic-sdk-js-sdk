...
/**
 * Enum for MigrationExchangeErrorEnum
 */
export enum MigrationExchangeErrorEnum {
  NotEnterpriseTeam = 'not_enterprise_team',
...
/**
 * Schema for MigrationExchangeErrorEnum
 */
export const migrationExchangeErrorEnumSchema: Schema<MigrationExchangeErrorEnum> = stringEnum(
