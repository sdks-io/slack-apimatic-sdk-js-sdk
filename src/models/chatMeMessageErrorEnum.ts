...
/**
 * Enum for ChatMeMessageErrorEnum
 */
export enum ChatMeMessageErrorEnum {
...
/**
 * Schema for ChatMeMessageErrorEnum
 */
export const chatMeMessageErrorEnumSchema: Schema<ChatMeMessageErrorEnum> = stringEnum(
