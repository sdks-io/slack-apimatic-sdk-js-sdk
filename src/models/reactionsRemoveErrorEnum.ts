...
/**
 * Enum for ReactionsRemoveErrorEnum
 */
export enum ReactionsRemoveErrorEnum {
...
/**
 * Schema for ReactionsRemoveErrorEnum
 */
export const reactionsRemoveErrorEnumSchema: Schema<ReactionsRemoveErrorEnum> = stringEnum(
