...
/**
 * Enum for AppsPermissionsResourcesListErrorEnum
 */
export enum AppsPermissionsResourcesListErrorEnum {
...
/**
 * Schema for AppsPermissionsResourcesListErrorEnum
 */
export const appsPermissionsResourcesListErrorEnumSchema: Schema<AppsPermissionsResourcesListErrorEnum> = stringEnum(
