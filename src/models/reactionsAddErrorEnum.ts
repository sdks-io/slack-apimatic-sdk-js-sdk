...
/**
 * Enum for ReactionsAddErrorEnum
 */
export enum ReactionsAddErrorEnum {
...
/**
 * Schema for ReactionsAddErrorEnum
 */
export const reactionsAddErrorEnumSchema: Schema<ReactionsAddErrorEnum> = stringEnum(
