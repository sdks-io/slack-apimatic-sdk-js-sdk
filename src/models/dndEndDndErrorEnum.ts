...
/**
 * Enum for DndEndDndErrorEnum
 */
export enum DndEndDndErrorEnum {
...
/**
 * Schema for DndEndDndErrorEnum
 */
export const dndEndDndErrorEnumSchema: Schema<DndEndDndErrorEnum> = stringEnum(
  DndEndDndErrorEnum
);
