...
/**
 * Enum for UsersSetPhotoErrorEnum
 */
export enum UsersSetPhotoErrorEnum {
  BadImage = 'bad_image',
  TooLarge = 'too_large',
...
/**
 * Schema for UsersSetPhotoErrorEnum
 */
export const usersSetPhotoErrorEnumSchema: Schema<UsersSetPhotoErrorEnum> = stringEnum(
