...
/**
 * Enum for ConversationsArchiveErrorEnum
 */
export enum ConversationsArchiveErrorEnum {
...
/**
 * Schema for ConversationsArchiveErrorEnum
 */
export const conversationsArchiveErrorEnumSchema: Schema<ConversationsArchiveErrorEnum> = stringEnum(
