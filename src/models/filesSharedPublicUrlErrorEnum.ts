...
/**
 * Enum for FilesSharedPublicUrlErrorEnum
 */
export enum FilesSharedPublicUrlErrorEnum {
...
/**
 * Schema for FilesSharedPublicUrlErrorEnum
 */
export const filesSharedPublicUrlErrorEnumSchema: Schema<FilesSharedPublicUrlErrorEnum> = stringEnum(
