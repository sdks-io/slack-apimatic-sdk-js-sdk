...
/**
 * Enum for ConversationsUnarchiveErrorEnum
 */
export enum ConversationsUnarchiveErrorEnum {
...
/**
 * Schema for ConversationsUnarchiveErrorEnum
 */
export const conversationsUnarchiveErrorEnumSchema: Schema<ConversationsUnarchiveErrorEnum> = stringEnum(
