...
/**
 * Enum for ChatDeleteErrorEnum
 */
export enum ChatDeleteErrorEnum {
...
/**
 * Schema for ChatDeleteErrorEnum
 */
export const chatDeleteErrorEnumSchema: Schema<ChatDeleteErrorEnum> = stringEnum(
  ChatDeleteErrorEnum
);
