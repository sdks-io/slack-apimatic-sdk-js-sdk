...
/**
 * Enum for RtmConnectErrorEnum
 */
export enum RtmConnectErrorEnum {
...
/**
 * Schema for RtmConnectErrorEnum
 */
export const rtmConnectErrorEnumSchema: Schema<RtmConnectErrorEnum> = stringEnum(
  RtmConnectErrorEnum
);
