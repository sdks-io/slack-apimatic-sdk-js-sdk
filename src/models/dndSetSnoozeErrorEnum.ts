...
/**
 * Enum for DndSetSnoozeErrorEnum
 */
export enum DndSetSnoozeErrorEnum {
  MissingDuration = 'missing_duration',
  SnoozeFailed = 'snooze_failed',
...
/**
 * Schema for DndSetSnoozeErrorEnum
 */
export const dndSetSnoozeErrorEnumSchema: Schema<DndSetSnoozeErrorEnum> = stringEnum(
