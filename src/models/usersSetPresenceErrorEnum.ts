...
/**
 * Enum for UsersSetPresenceErrorEnum
 */
export enum UsersSetPresenceErrorEnum {
...
/**
 * Schema for UsersSetPresenceErrorEnum
 */
export const usersSetPresenceErrorEnumSchema: Schema<UsersSetPresenceErrorEnum> = stringEnum(
