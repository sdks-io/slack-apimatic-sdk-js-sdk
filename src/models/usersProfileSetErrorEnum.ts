...
/**
 * Enum for UsersProfileSetErrorEnum
 */
export enum UsersProfileSetErrorEnum {
...
/**
 * Schema for UsersProfileSetErrorEnum
 */
export const usersProfileSetErrorEnumSchema: Schema<UsersProfileSetErrorEnum> = stringEnum(
