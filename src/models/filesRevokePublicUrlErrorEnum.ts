...
/**
 * Enum for FilesRevokePublicUrlErrorEnum
 */
export enum FilesRevokePublicUrlErrorEnum {
...
/**
 * Schema for FilesRevokePublicUrlErrorEnum
 */
export const filesRevokePublicUrlErrorEnumSchema: Schema<FilesRevokePublicUrlErrorEnum> = stringEnum(
