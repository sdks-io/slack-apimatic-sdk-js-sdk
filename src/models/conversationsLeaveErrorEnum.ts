...
/**
 * Enum for ConversationsLeaveErrorEnum
 */
export enum ConversationsLeaveErrorEnum {
  MethodNotSupportedForChannelType = 'method_not_supported_for_channel_type',
  LastMember = 'last_member',
  MissingScope = 'missing_scope',
  ChannelNotFound = 'channel_not_found',
  IsArchived = 'is_archived',
  CantLeaveGeneral = 'cant_leave_general',
...
/**
 * Schema for ConversationsLeaveErrorEnum
 */
export const conversationsLeaveErrorEnumSchema: Schema<ConversationsLeaveErrorEnum> = stringEnum(
