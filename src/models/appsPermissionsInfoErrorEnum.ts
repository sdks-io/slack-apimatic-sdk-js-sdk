...
/**
 * Enum for AppsPermissionsInfoErrorEnum
 */
export enum AppsPermissionsInfoErrorEnum {
...
/**
 * Schema for AppsPermissionsInfoErrorEnum
 */
export const appsPermissionsInfoErrorEnumSchema: Schema<AppsPermissionsInfoErrorEnum> = stringEnum(
