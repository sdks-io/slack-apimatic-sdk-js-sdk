...
/**
 * Enum for ConversationsInfoErrorEnum
 */
export enum ConversationsInfoErrorEnum {
...
/**
 * Schema for ConversationsInfoErrorEnum
 */
export const conversationsInfoErrorEnumSchema: Schema<ConversationsInfoErrorEnum> = stringEnum(
