...
/**
 * Enum for BotsInfoErrorEnum
 */
export enum BotsInfoErrorEnum {
...
/**
 * Schema for BotsInfoErrorEnum
 */
export const botsInfoErrorEnumSchema: Schema<BotsInfoErrorEnum> = stringEnum(
  BotsInfoErrorEnum
);
