...
/**
 * Enum for ConversationsRenameErrorEnum
 */
export enum ConversationsRenameErrorEnum {
...
/**
 * Schema for ConversationsRenameErrorEnum
 */
export const conversationsRenameErrorEnumSchema: Schema<ConversationsRenameErrorEnum> = stringEnum(
