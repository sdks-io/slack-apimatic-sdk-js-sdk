...
/**
 * Enum for ChatScheduledMessagesListErrorEnum
 */
export enum ChatScheduledMessagesListErrorEnum {
...
/**
 * Schema for ChatScheduledMessagesListErrorEnum
 */
export const chatScheduledMessagesListErrorEnumSchema: Schema<ChatScheduledMessagesListErrorEnum> = stringEnum(
