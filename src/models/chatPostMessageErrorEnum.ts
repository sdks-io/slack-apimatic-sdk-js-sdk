...
/**
 * Enum for ChatPostMessageErrorEnum
 */
export enum ChatPostMessageErrorEnum {
...
/**
 * Schema for ChatPostMessageErrorEnum
 */
export const chatPostMessageErrorEnumSchema: Schema<ChatPostMessageErrorEnum> = stringEnum(
