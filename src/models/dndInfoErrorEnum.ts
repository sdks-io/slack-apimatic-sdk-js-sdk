...
/**
 * Enum for DndInfoErrorEnum
 */
export enum DndInfoErrorEnum {
...
/**
 * Schema for DndInfoErrorEnum
 */
export const dndInfoErrorEnumSchema: Schema<DndInfoErrorEnum> = stringEnum(
  DndInfoErrorEnum
);
