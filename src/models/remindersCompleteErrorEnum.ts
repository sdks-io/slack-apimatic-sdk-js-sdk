...
/**
 * Enum for RemindersCompleteErrorEnum
 */
export enum RemindersCompleteErrorEnum {
  NotFound = 'not_found',
  CannotCompleteRecurring = 'cannot_complete_recurring',
  CannotCompleteOthers = 'cannot_complete_others',
...
/**
 * Schema for RemindersCompleteErrorEnum
 */
export const remindersCompleteErrorEnumSchema: Schema<RemindersCompleteErrorEnum> = stringEnum(
