...
/**
 * Enum for UsersProfileGetErrorEnum
 */
export enum UsersProfileGetErrorEnum {
...
/**
 * Schema for UsersProfileGetErrorEnum
 */
export const usersProfileGetErrorEnumSchema: Schema<UsersProfileGetErrorEnum> = stringEnum(
