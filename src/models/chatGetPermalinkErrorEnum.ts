...
/**
 * Enum for ChatGetPermalinkErrorEnum
 */
export enum ChatGetPermalinkErrorEnum {
...
/**
 * Schema for ChatGetPermalinkErrorEnum
 */
export const chatGetPermalinkErrorEnumSchema: Schema<ChatGetPermalinkErrorEnum> = stringEnum(
