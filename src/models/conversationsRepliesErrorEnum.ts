...
/**
 * Enum for ConversationsRepliesErrorEnum
 */
export enum ConversationsRepliesErrorEnum {
...
/**
 * Schema for ConversationsRepliesErrorEnum
 */
export const conversationsRepliesErrorEnumSchema: Schema<ConversationsRepliesErrorEnum> = stringEnum(
