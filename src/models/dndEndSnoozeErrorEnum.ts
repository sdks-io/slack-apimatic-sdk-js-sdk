...
/**
 * Enum for DndEndSnoozeErrorEnum
 */
export enum DndEndSnoozeErrorEnum {
...
/**
 * Schema for DndEndSnoozeErrorEnum
 */
export const dndEndSnoozeErrorEnumSchema: Schema<DndEndSnoozeErrorEnum> = stringEnum(
