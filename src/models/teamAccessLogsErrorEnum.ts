...
/**
 * Enum for TeamAccessLogsErrorEnum
 */
export enum TeamAccessLogsErrorEnum {
  PaidOnly = 'paid_only',
  OverPaginationLimit = 'over_pagination_limit',
...
/**
 * Schema for TeamAccessLogsErrorEnum
 */
export const teamAccessLogsErrorEnumSchema: Schema<TeamAccessLogsErrorEnum> = stringEnum(
