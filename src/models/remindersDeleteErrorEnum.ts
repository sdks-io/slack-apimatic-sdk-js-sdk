...
/**
 * Enum for RemindersDeleteErrorEnum
 */
export enum RemindersDeleteErrorEnum {
  NotFound = 'not_found',
...
/**
 * Schema for RemindersDeleteErrorEnum
 */
export const remindersDeleteErrorEnumSchema: Schema<RemindersDeleteErrorEnum> = stringEnum(
